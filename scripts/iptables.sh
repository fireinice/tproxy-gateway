...
# FORWARD ALL
iptables -t mangle -A clash -p udp -j TPROXY --on-port $PROXY_PORT --on-ip 0.0.0.0 --tproxy-mark 1
iptables -t mangle -A clash -p tcp -j TPROXY --on-port $PROXY_PORT --on-ip 0.0.0.0 --tproxy-mark 1
